            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshots) {
                if(snapshots.connectionState == ConnectionState.waiting){
                  ...
                  return const Center(
                    child: Text("You have no sessions today",
                    style: TextStyle(
                      fontSize: 20,
                      color: Colors.black,
                    ),),
                              ...
                              PopupMenuItem<String>(
                                ...
                                onTap: () async {
                                  await FirebaseFirestore.instance.collection(
                                      'counsellor').doc('counsellor@gmail.com')
                                      .collection('session').doc(
                                      snapshots.data!.docs[index].id.toString())
                                      .delete()
                                      .then((value) async {
                                    await FirebaseFirestore.instance.collection(
                                        'users').doc(data['user']).collection(
                                        'session').doc(
                                        snapshots.data!.docs[index].id
                                            .toString()).delete().then((value) {
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshots) {
                ...
                child: CircularProgressIndicator(),
                  ...
                  return const Center(
                    child: Text("No sessions are scheduled",
                      style: TextStyle(
                        fontSize: 20,
                        color: Colors.black,
                      ),),
